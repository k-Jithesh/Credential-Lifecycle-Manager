...
## Data foundation: CLMTables 1.2.2.0
...
|---|---|---|
| `CLMTables` | 1.2.2.0 packaged | Tables, choices, relationships, roles, per-group reminder schedules, and Credential public views |
...
Normal deployment uses solution import. Clean installs start with `CLMTables_1_2_2_0.zip`, followed by the packaged connectors, discovery flow, `CLMNotifications_1_1_0_0.zip`, and `CLMApp_1_0_0_5.zip`. Install `CLMNotificationDispatchers_1_0_0_0.zip` only where Dataverse, Outlook, and Teams are permitted together.
