...
The notification data model is packaged as `CLMTables_1_2_0_0.zip`. Notification resolution and queueing are packaged as `CLMNotifications_1_1_0_0.zip`.

The deployment packages are:

- `CLMTables_1_2_0_0.zip`
